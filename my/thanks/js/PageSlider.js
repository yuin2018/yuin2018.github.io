(function ($, window) {
    ...
    var defaults = {
        ...
        shareUrl: 'http://job.dajiangxia.com/test/index.php', //默认分享方式
        baseUrl: '',
    ...
    PageSlider.prototype = {
        ...
        next: function () {
            ...
            if($(this.curPage[0]).hasClass('page10')){
        ...
        _initWeixin: function () {
            var url = location.href.split('#')[0];
            $.ajax({
                url: 'https://yidian.weiyihui.com.cn/weixinshare/index.php', // http://phptest.guoxinad.com.cn/weixinshare/index.php
                type: "get",            // 数据发送方式
        ...
        _loadimg: function (imgarr, callback) {
            ...
            if(imgLength>0){
                ...
                loader.addProgressListener(function (e) {
                    ...
                    $('.loadPro').css({ 'width': (520*percent/100)+'px' });
        ...
        wxShare: function (sharetitle1, sharedesc, url1, url2, callback) {
            wx.ready(function () {
